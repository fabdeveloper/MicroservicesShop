...
//        rs = restTemplate.postForObject(getShopIntegration().getProductServiceUrl() + "/productPurchaseConfirm", rq, ProductConfirmRS.class);
    ...
    public ProductPurchaseCancelRS productPurchaseCancelTestHelper() {
    	ProductPurchaseCancelRS rs = null;
...
//        rs = restTemplate.postForObject(getShopIntegration().getProductServiceUrl() + "/productPurchaseCancel", rq, ProductPurchaseCancelRS.class);
