...
// import fab.shop.microservices.core.mapper.MapperTesterImpl;


@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
public class MapperTest {
    
    // private MapperTesterImpl mapper = new MapperTesterImpl();
    ...
    public void shopEntityObjectTest(){
        ...
        assertTrue(false, "shopEntityObjectTest() NO VA BIEN --------------");
    }
}
